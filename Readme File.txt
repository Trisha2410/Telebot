...
- In the Terminal type the following commands to install the libraries,this will check the exsisiting version and will install the latest one.
	...
	- pip install scikit-learn==0.20.2 # for profanity-check version of scikit-learn is mandatory
	- pip install keras
	- pip install nltk
	- pip install numpy
	- pip install pandas
...
- for creating light weight binary files.
	import pickle
- for importing the model created. 
	from keras.models import load_model
- for reading and formating the Intents.json file.
	import json
...
- for checking the language profanity
