...
# neurons equal to number of intents to predict output intent using softmax
...
adamOpti = Adam(lr = 0.02) #acuracy: 93.22 8153

sgd = SGD(lr=0.01, decay=1e-6, momentum=0.9, nesterov=True)  #acuracy: 98.7
model.compile(loss='categorical_crossentropy', optimizer=adamOpti, metrics=['accuracy'])
